...
def load_model(model_name, loader=None):
    ...
    if loader is None:
        if shared.args.loader is not None and shared.args.loader != '':
    ...
    if tokenizer.__class__.__name__ == 'LlamaTokenizer':
        ...
        for pair in pairs:
            ...
            if p.exists():
                ...
                if file_hash != pair[1]:
                    print(f"{p} is different from the original LlamaTokenizer file. It is either customized or outdated.")
    ...
    # Custom
        ...
        if shared.args.cpu:
            ...
            if shared.args.load_in_4bit:
                ...
                print("Using the following 4-bit params: " + str(quantization_config_params))
...
def vllm_loader(model_name):
    ...
    model = LLM(model=shared.args.model_dir + model_name)
